        ...
        <div className="creeds-content">
          <div className="creeds-content-same">
            <div className="circle">
              <img src="/flaticons/stars.png" className="creeds-icons-pic" />
            </div>
          ...
          <div className="creeds-content-same">
            <div className="circle">
              <img src="/flaticons/view.png" className="creeds-icons-pic" />
            </div>
          ...
          <div className="creeds-content-same">
            <div className="circle">
              <img src="/flaticons/like.png" className="creeds-icons-pic" />
            </div>
